...
def process_file(inpt: cimr.data.inputs.Input, input_file: Path) -> InputDataStatistics:
    """
...
def add_parser(subparsers):
    ...
    function is called from the top-level parser defined in 'cimr.bin'.
