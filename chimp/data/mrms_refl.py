...
from chimp.utils import round_time, get_available_times
...
def process_day(
    ...
    Args:
        ...
        time_step: Time step defining the temporal resolution at which to extract
            training samples.
        conditional: A folder containing CHIMP files from a different source.
            CHIMP will only extract reference data that matches the time stamps
