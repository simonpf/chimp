...
from chimp.config import EncoderConfig, InputConfig
        ...
        for stage, f_d in enumerate(shared_cfg.downsampling_factors):
            for cfg in input_configs:
                if cfg.scale == scale:
                    ...
                    stem_factories[cfg.name] = stem_fac
                    inputs[cfg.name] = min_input_scale
