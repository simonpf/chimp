...
from chimp.config import EncoderConfig, ModelConfig
from chimp.models.blocks import get_block_factory, get_stage_factory
...
def compile_sequence_model(model_config: ModelConfig) -> nn.Module:
    ...
    """
    from chimp.models import compile_decoder, Head
